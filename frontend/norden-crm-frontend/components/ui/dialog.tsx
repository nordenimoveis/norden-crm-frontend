  ...
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // max-h + overflow-y-auto: dialogs com bastante conteúdo (formulários
        // longos, ex: campanha com upload de mídia) ficam roláveis por dentro
        // em vez de estourar a tela sem jeito de ver o resto.
